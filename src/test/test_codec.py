...
class EncodedData():
    ...
    def __init__(self, main_data_num_bytes, encoded_main_data, main_data_padding):
        self.main_data_num_bytes = main_data_num_bytes
...
def test_read_write_simple(test_file, case):
    ...
    height = 64
    block_size = 8
    main_data_num_bytes = case.main_data_num_bytes
    encoded_main_data = case.encoded_main_data
    main_data_padding = case.main_data_padding
    filename = test_file
